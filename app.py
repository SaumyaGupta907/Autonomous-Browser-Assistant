...
# Open Gradio app
# ↓
# Create Sidekick object
# ↓
# User enters task + success criteria
# ↓
# Send it to LangGraph agent
# ↓
# Show assistant answer + evaluator feedback in chat
# ↓
# Reset/cleanup when needed
